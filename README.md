...
[![Go Reference](https://pkg.go.dev/badge/github.com/seatsio/seatsio-go.svg)](https://pkg.go.dev/github.com/seatsio/seatsio-go/v10)
...
```
require (
    github.com/seatsio/seatsio-go/v10 v10.0.0
)
```
